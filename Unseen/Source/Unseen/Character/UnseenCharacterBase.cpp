...
AUnseenCharacterBase::AUnseenCharacterBase()
{
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> AnimInstanceClassRef(TEXT("/Game/Characters/Mannequins/Animations/Mixamo/ABP_Locomotion.ABP_Locomotion_C"));
